...
/// please report them to me.
 public final class AIProxyCertificatePinningDelegate: NSObject, URLSessionDelegate, URLSessionTaskDelegate {

    private var _progressCallback: (@Sendable (Double) -> Void)?
 ...
 // MARK: - Private
private let publicKeysAsData: [Data] = {
